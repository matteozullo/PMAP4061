...
* **Score your policy alternatives** using qualitative or quantitative methods of choosing. One such method must involve some financial analysis from the cost numbers you compiled (included in the Appendix). This might be a full-blown cost-benefit analysis or a quick-and-dirty cost-benefit ratio measure. Sometimes, one given policy alternative dominates rival policies by orders of magnitude thus rendering a cost-benefit analysis totally unnecessary. Explain what you are doing and list any assumptions. A Goeller scorecard display of your alternatives and criteria may be be useful to summarize the information.
