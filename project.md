...
* **Score your policy alternatives** using qualitative or quantitative methods of choosing. One such method must involve some financial analysis from the cost numbers you compiled (included in the Appendix). This might be a full-blown cost-benefit analysis or a quick-and-dirty cost-benefit ratio measure. Sometimes, one given policy alternative dominates rival policies by orders of magnitude, in which case a cost-benefit analysis might be totally unnecessary. Explain what you are doing and list any assumptions. A Goeller scorecard display of your alternatives and criteria may be be useful to summarize the information.
...
* Have I considered the policy space in full or am I giving a full answer to what is a partial definition of the policy problem? That is, you want your presentation to be **comprehensive**.
* Will my presentation withstand the most likely challenges from the audience? That is, you want your presentation to be **coherent**.
* Will my policy recommendations fall flat or do they call for immediate action? That is, you want your presentation to be **actionable**.

### Conclusions
This section will not introduce new information but **restate your main points** and the call for action. Please note that most non-academic readers will start or even limit their reading time to the *Conclusions*. Therefore, it is paramount to keep the delivery crisp and clear. As a side-benefit, there will likely be no need for an *Executive Summary* if your *Conclusions* section is a good enough wrap-up for your policy report. Different policy analysts tend to use one or the other, and often times featuring both might only add redundancies to the report.
